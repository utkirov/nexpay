...
.grabbing {
  @apply w-full h-1/2 flex absolute bottom-0 left-0 justify-center bg-contain items-center  bg-center
}
...
.grabbing__button a {
  @apply h-[170px] w-[250px] bottom-[15%] left-1/4 flex flex-col items-center justify-center
}
